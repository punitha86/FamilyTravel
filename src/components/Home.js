...
const Home = props => {
		...
		return (
			...
			<p>
			If there's one time you want to be organized, it's when you're traveling. These tips for creating itineraries, packing carry-ons, and organizing your travel mementos will help make sure your trip goes smoothly. Cut the stress by taking a few simple steps to plan.</p>
			</Row>
			<CardDeck>
